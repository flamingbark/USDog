...
export interface MockApi3MarketV2Interface extends Interface {
    getFunction(nameOrSignature: "DAPI_MANAGEMENT_MERKLE_ROOT_HASH_TYPE" | "DAPI_PRICING_MERKLE_ROOT_HASH_TYPE" | "MAXIMUM_DAPI_UPDATE_AGE" | "SIGNED_API_URL_MERKLE_ROOT_HASH_TYPE" | "addSubscriptionToQueue_" | "airseekerRegistry" | "api3ReaderProxyV1Factory" | "api3ServerV1" | "buySubscription" | "cancelSubscriptions" | "computeExpectedSponsorWalletBalance" | "computeExpectedSponsorWalletBalanceAfterSubscriptionIsAdded" | "containsBytecode" | "dapiNameToCurrentSubscriptionId" | "deployApi3ReaderProxyV1" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "getDapiData" | "getDataFeedData" | "getHashValue" | "hashTypeToSignersHash" | "hashes" | "maximumSubscriptionQueueLength" | "multicall" | "multicallAndBuySubscription" | "owner" | "registerDataFeed" | "registerHash" | "renounceOwnership" | "setAirseekerRegistry" | "setHash" | "setSigners" | "signatureDelegationHashType" | "subscriptionIdToUpdateParameters" | "subscriptions" | "transferOwnership" | "tryMulticall" | "tryMulticallAndBuySubscription" | "updateBeaconSetWithBeacons" | "updateBeaconWithSignedData" | "updateCurrentSubscriptionId" | "updateDapiName" | "updateSignedApiUrl"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BoughtSubscription" | "CanceledSubscriptions" | "OwnershipTransferred" | "RegisteredHash" | "SetAirseekerRegistry" | "SetHash" | "SetSigners" | "UpdatedCurrentSubscriptionId"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "addSubscriptionToQueue_", values: [BytesLike, BytesLike, BytesLike, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "airseekerRegistry", values?: undefined): string;
    encodeFunctionData(functionFragment: "api3ReaderProxyV1Factory", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setAirseekerRegistry", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "addSubscriptionToQueue_", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "airseekerRegistry", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "api3ReaderProxyV1Factory", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setAirseekerRegistry", data: BytesLike): Result;
...
export declare namespace SetAirseekerRegistryEvent {
    type InputTuple = [airseekerRegistry: AddressLike];
    type OutputTuple = [airseekerRegistry: string];
    interface OutputObject {
        airseekerRegistry: string;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
    type Filter = TypedDeferredTopicFilter<Event>;
    type Log = TypedEventLog<Event>;
...
export interface MockApi3MarketV2 extends BaseContract {
    connect(runner?: ContractRunner | null): MockApi3MarketV2;
    waitForDeployment(): Promise<this>;
    interface: MockApi3MarketV2Interface;
    ...
    addSubscriptionToQueue_: TypedContractMethod<[
        dapiName: BytesLike,
        dataFeedId: BytesLike,
        updateParameters: BytesLike,
        duration: BigNumberish,
    ...
    api3ReaderProxyV1Factory: TypedContractMethod<[], [string], "view">;
    ...
    setAirseekerRegistry: TypedContractMethod<[
        airseekerRegistry_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "addSubscriptionToQueue_"): TypedContractMethod<[
        dapiName: BytesLike,
        dataFeedId: BytesLike,
        updateParameters: BytesLike,
        duration: BigNumberish,
    ...
    getFunction(nameOrSignature: "api3ReaderProxyV1Factory"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "dapiNameToCurrentSubscriptionId"): TypedContractMethod<[arg0: BytesLike], [string], "view">;
    ...
    getFunction(nameOrSignature: "setAirseekerRegistry"): TypedContractMethod<[
        airseekerRegistry_: AddressLike
    ], [
        void
    ], "nonpayable">;
    ...
    getEvent(key: "SetAirseekerRegistry"): TypedContractEvent<SetAirseekerRegistryEvent.InputTuple, SetAirseekerRegistryEvent.OutputTuple, SetAirseekerRegistryEvent.OutputObject>;
    ...
    filters: {
        ...
        "SetAirseekerRegistry(address)": TypedContractEvent<SetAirseekerRegistryEvent.InputTuple, SetAirseekerRegistryEvent.OutputTuple, SetAirseekerRegistryEvent.OutputObject>;
        SetAirseekerRegistry: TypedContractEvent<SetAirseekerRegistryEvent.InputTuple, SetAirseekerRegistryEvent.OutputTuple, SetAirseekerRegistryEvent.OutputObject>;
...
//# sourceMappingURL=MockApi3MarketV2.d.ts.map