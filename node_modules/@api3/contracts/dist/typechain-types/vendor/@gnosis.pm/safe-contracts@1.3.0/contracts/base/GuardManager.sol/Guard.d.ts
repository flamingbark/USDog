...
export interface GuardInterface extends Interface {
    getFunction(nameOrSignature: "checkAfterExecution" | "checkTransaction"): FunctionFragment;
...
export interface Guard extends BaseContract {
    connect(runner?: ContractRunner | null): Guard;
